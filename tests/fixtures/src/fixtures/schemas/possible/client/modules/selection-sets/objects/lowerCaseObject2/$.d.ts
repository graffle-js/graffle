...
export type * as lowerCaseObject2 from './$$.js';
/**
 ...
 * | **Fields** | 1 |
 */
export interface lowerCaseObject2<_$Context extends $$Utilities.Docpar.Object.Select.SelectionContext = $DefaultSelectionContext> extends $$Utilities.Docpar.Object.Select.Bases.ObjectLike {
    /**
     * # Info
     *
     * | | |
