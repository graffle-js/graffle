...
export interface Object1ImplementingInterface {
    <$SelectionSet>(selectionSet: $$Utilities.NoExcess<$SelectionSet, $$SelectionSets.Object1ImplementingInterface>): $SelectionSet;
}
/**
 * Build type-safe selection set for Object2ImplementingInterface.
 */
export interface Object2ImplementingInterface {
    <$SelectionSet>(selectionSet: $$Utilities.NoExcess<$SelectionSet, $$SelectionSets.Object2ImplementingInterface>): $SelectionSet;
}
/**
...
export interface ObjectNestedWithArgs {
    <$SelectionSet>(selectionSet: $$Utilities.NoExcess<$SelectionSet, $$SelectionSets.ObjectNestedWithArgs>): $SelectionSet;
}
/**
...
export interface InterfaceGrandparent {
    <$SelectionSet>(selectionSet: $$Utilities.NoExcess<$SelectionSet, $$SelectionSets.InterfaceGrandparent>): $SelectionSet;
}
/**
...
//# sourceMappingURL=methods-select.d.ts.map