...
export interface Document<$Context> {
    <$Document>(document: $$Utilities.NoExcessNonEmpty<$Document, $$SelectionSets.$Document<{
        scalars: $Context['scalars'];
    }>>): $$Utilities.DocumentRunner<$Context, $$Schema.Schema, $Document>;
}
/**
...
//# sourceMappingURL=methods-document.d.ts.map