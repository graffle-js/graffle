...
export type * as ObjectNested from './$$.js';
/**
 ...
 * | **Fields** | 2 |
 */
export interface ObjectNested<_$Context extends $$Utilities.Docpar.Object.Select.SelectionContext = $DefaultSelectionContext> extends $$Utilities.Docpar.Object.Select.Bases.ObjectLike {
    /**
     * # Info
     *
     * | | |
