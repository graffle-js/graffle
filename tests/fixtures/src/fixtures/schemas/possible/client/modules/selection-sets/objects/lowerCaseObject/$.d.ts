...
export type * as lowerCaseObject from './$$.js';
/**
 ...
 * | **Fields** | 1 |
 */
export interface lowerCaseObject<_$Context extends $$Utilities.Docpar.Object.Select.SelectionContext = $DefaultSelectionContext> extends $$Utilities.Docpar.Object.Select.Bases.ObjectLike {
    /**
     * # Info
     *
     * | | |
