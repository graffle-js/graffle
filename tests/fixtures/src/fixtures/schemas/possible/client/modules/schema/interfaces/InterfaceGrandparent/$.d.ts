import type { InterfaceChildA, InterfaceChildB, InterfaceParent, ObjectChildA, ObjectChildB, ObjectGrandparent, ObjectParent } from '../../$$.js';
...
export interface InterfaceGrandparent {
    ...
    implementorsUnion: ObjectChildA | ObjectChildB | ObjectGrandparent | ObjectParent | InterfaceChildA | InterfaceChildB | InterfaceParent;
    implementorsIndex: {
