...
export type * as ObjectUnion from './$$.js';
/**
 ...
 * | **Fields** | 1 |
 */
export interface ObjectUnion<_$Context extends $$Utilities.Docpar.Object.Select.SelectionContext = $DefaultSelectionContext> extends $$Utilities.Docpar.Object.Select.Bases.ObjectLike {
    /**
     * # Info
     *
     * | | |
     ...
     */
    fooBarUnion?: $Fields.fooBarUnion.$Expanded<_$Context> | $$Utilities.Docpar.Object.Select.SelectAlias.SelectAlias<$Fields.fooBarUnion<_$Context>>;
    /**
