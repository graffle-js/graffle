...
export type * as BattleTrainer from './__.js'
...
> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
  ...
  combatant1?:
    ...
    | GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.combatant1<_$Context>>
  /**
   * # Info
   *
   * | | |
  ...
  combatant2?:
    ...
    | GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.combatant2<_$Context>>
  /**
   * # Info
   *
   * | | |
  ...
  winner?:
    ...
    | GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.winner<_$Context>>
