...
export type * as Trainer from './__.js'
...
> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
  ...
  class?:
    ...
    | GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.class<_$Context>>
  ...
  fans?:
    ...
    | GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.fans<_$Context>>
  /**
   * # Info
   *
   * | | |
