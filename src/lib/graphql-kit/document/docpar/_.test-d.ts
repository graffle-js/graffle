...
type ContextStrict = GraphqlKit.Document.ParserContext<Possible.$.Schema, Possible.$.SchemaDrivenDataMap, never>
type ContextLoose = GraphqlKit.Document.ParserContext<undefined>

type Strict<$Input extends GraphqlKit.Document.Input> = GraphqlKit.Document.Parse<$Input, ContextStrict>
type Loose<$Input extends GraphqlKit.Document.Input> = GraphqlKit.Document.Parse<$Input, ContextLoose>
...
type E = GraphqlKit.Document.Errors.ErrorFieldNotFound<{
  fieldName: 'bad'
  parentName: 'Object1'
