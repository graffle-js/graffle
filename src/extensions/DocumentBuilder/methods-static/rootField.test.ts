...
test('type output inference', () => {
  ...
  Ts.Test.exact<Grafaid.Document.Typed.String<{ date: string | null }, {}, true>>()(q3)
  const q3b = PossibleWithScalars.query.date(true)
  Ts.Test.exact<Grafaid.Document.Typed.String<{ date: Date | null }, {}, true>>()(q3b)
...
test('SDDM type branding', () => {
  ...
  Ts.Test.exact<typeof generatedDoc>()(generatedDoc)
