...
Test.describe('DocumentBuilder Runtime')
  ...
  .casesIn<{ hoistArguments?: boolean }>('Arguments - Enums')(
  ...
  .casesIn<{ hoistArguments?: boolean }>('Arguments - Scalars and Objects')(
  ...
  .casesIn<{ hoistArguments?: boolean }>('Directives - $skip')(
  ...
  .casesIn<{ hoistArguments?: boolean }>('Inline Fragments')(
  ...
  .casesIn<{ hoistArguments?: boolean }>('Unions')(
  ...
  .casesIn<{ hoistArguments?: boolean }>('Aliases')(
  ...
  .casesIn<{ hoistArguments?: boolean }>('Arguments - Aliases')(
  ...
  .casesIn<{ hoistArguments?: boolean }>('Other')(
