 ...
 * }
 *
 * type MyQueryBuilder = StaticDocumentBuilder<MyConfig, GraphqlKit.Schema.Runtime.OperationType.QUERY>
 * ```
 */
 ...
 *
 * const query = createStaticRootType(GraphqlKit.Schema.Runtime.OperationType.QUERY)
 *
