...
const query = Docpar.Object.Static.createStaticRootType(GraphqlKit.Schema.Runtime.OperationType.QUERY) as any
const mutation = Docpar.Object.Static.createStaticRootType(GraphqlKit.Schema.Runtime.OperationType.MUTATION) as any
const subscription = Docpar.Object.Static.createStaticRootType(
  GraphqlKit.Schema.Runtime.OperationType.SUBSCRIPTION,
) as any
...
test('static document builder > manual createStaticRootType usage - runtime works without types', () => {
  ...
  const manualQuery = Docpar.Object.Static.createStaticRootType(GraphqlKit.Schema.Runtime.OperationType.QUERY) as any
