...
type _ = [
  ...
  //
  Graffle.$Fields.Query['pokemons$Arguments'],
  Graffle.$Fields.Query['trainerByName$Arguments'],
  Graffle.$Fields.Mutation['addPokemon$Arguments'],
  // ...
  //
  //
  // ======================
  ...
  //
  Graffle.$Fields.Query['pokemons$Expanded'],
  Graffle.$Fields.Mutation['addPokemon$Expanded'],
  // ...
  //
  // 5. Inline Fragments
  //    ----------------
  ...
  //
  Graffle.$Fields.Query['beings'],
  Graffle.$Fields.Query['beings$SelectionSet'],
  ...
  //
  Graffle.$Fields.Pokemon['name'],
  Graffle.$Fields.Pokemon['name$SelectionSet'],
]

const graffle = Graffle.create()

const getPokemonsLike = (filter: Graffle.$Fields.Query['pokemons$Arguments']['filter']) =>
