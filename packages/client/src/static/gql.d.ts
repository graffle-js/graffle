 ...
 */
export interface gql<$Schema extends Schema | undefined, $DocumentObjectConstraint, $ArgumentsMap> {
    <const $Input extends string>(graphqlDocument: $Input): Docpar.Parse<$Input, Docpar.ParserContext<$Schema>>;
    <const $Document extends $DocumentObjectConstraint>(documentObject: $Document, options?: Docpar.Object.ToGraphQLDocument.Options): $Document extends object ? Docpar.Parse<$Document, Docpar.ParserContext<$Schema, $ArgumentsMap, never>> : never;
}
/**
...
export declare namespace Gql {
     ...
     */
    type Arguments = [graphqlDocument: string] | [objectDocument: Docpar.Object.Select.Document.DocumentObject, options?: Docpar.Object.ToGraphQLDocument.Options];
    const normalizeArguments: (args: Arguments) => {
        type: "graphql";
        document: string;
        options: undefined;
    } | {
        type: "object";
        document: Docpar.Object.Select.Document.DocumentObject;
        options: any;
    };
}
export declare const defaults: Partial<Docpar.Object.ToGraphQLDocument.Options>;
export declare const createGql: <$Schema extends Schema | undefined, $DocumentObjectConstraint, $ArgumentsMap>(config: {
    sddm: $ArgumentsMap;
 ...
 */
export declare const gql: gql<any, unknown, any>;
/**
 ...
 * ```
 */
export type ParseGraphQLString<$Context, $Input extends string> = GlobalRegistry.ForContext<$Context> extends never ? Docpar.Parse<$Input, Docpar.ParserContext<undefined>> : Docpar.Parse<$Input, Docpar.ParserContext<GlobalRegistry.ForContext<$Context>['schema']>>;
/**
 ...
 * ```
 */
export type ParseGraphQLObject<$Context, $Document> = Docpar.Parse<$Document, Docpar.ParserContext<GlobalRegistry.ForContext<$Context>['schema'], GlobalRegistry.ForContext<$Context>['argumentsMap'], $Context extends {
    typeHookRequestResultDataTypes: infer $TypeHooks;
} ? $TypeHooks : never>>;
