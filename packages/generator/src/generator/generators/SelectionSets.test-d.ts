import type { Possible } from '@test/fixtures/schemas/possible/client/$.js'
import type { PossibleNoCustomScalars } from '@test/fixtures/schemas/possible/clientNoCustomScalars/$.js'
