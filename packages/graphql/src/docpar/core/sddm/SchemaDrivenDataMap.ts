...
declare global {
  namespace GraffleGlobal {
    ...
    export interface SchemaDrivenDataMapOperations {
      [OperationTypeNode.MUTATION]?: SchemaDrivenDataMap.OutputObject
      [OperationTypeNode.QUERY]?: SchemaDrivenDataMap.OutputObject
      [OperationTypeNode.SUBSCRIPTION]?: SchemaDrivenDataMap.OutputObject
    }
